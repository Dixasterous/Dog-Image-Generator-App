...
def generateImg():
    ...
    PetImageLabel.configure(image=pet_image)
...
Title = ctk.CTkLabel(master=LeftMenuFrame, text="Dog Image\nGenerator", font=("Roboto", 24))
Title.grid(row=0, column=0, pady=30, padx=40)
...
PetImageLabel = ctk.CTkLabel(master=PetImageFrame, text='')
